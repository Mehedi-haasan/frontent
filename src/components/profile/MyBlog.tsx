...
import VievComment from '../blog/ViewComment';
...
const MyBlog : React.FC<VoteCardProps> = ({ id, name, image_url, title, message, user, images, like, comments, updated }) => {
                ...
                <section className='relative  mx-auto py-1 md:py-4 my-1 shadow-lg rounded-md border bg-white'>
                    <div className='grid grid-cols-12 mx-4 '>
                        <div className='grid col-span-11 py-1'>
                            <div className='flex'>
                                ...
                                <div>
                                    <Link href={`/blogdetails/${7}`} className='md:text-2xl ml-3 font-semibold'>{user.first_name} {user.last_name}</Link>
                        ...
                        <div className='grid col-span-1 float-right'>
                            <div className='flex'>
                                ...
                                <p className='p-2 text-right'><button className='float-right right-0 font-bold md:text-3xl' onClick={handleDeleteBlog}>del</button></p>
                    ...
                    <div className='mx-4 md:my-1 lg:my-2 relative'>
                        ...
                        <div className='mb-5 md:mb-8'>
                            ...
                            <div>
                                <Link href={`/blogdetails/${7}`}><img src={image_url} className='w-full h-full min-h-[200px] max-h-[500px] rounded' alt='' /></Link>
                            </div>
