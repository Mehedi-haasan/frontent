                  ...
                  <div className='grid col-span-12 lg:col-span-6 my-3'>
                     <div className=' w-[94%] mx-auto'>
                        ...
                        {cartData.map(({ qty, product_product }) => {
                           return <Card lebel={product_product.name} value={product_product.standard_price} qty={qty} />
                        })}
                        ...
                        <button onClick={PlaceOrder} className='block mx-auto py-2 w-full border rounded my-6 font-semibold text-white bg-black hover:bg-red-500'>Payment</button>
                     </div>
